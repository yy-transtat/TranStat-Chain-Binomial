...
#define INITIALIZE_SCORE_AND_INFO \
...
// UPDATE_MY_LOG_L does not involve preimmunity-related parameters, as thes eparameters have been updated
// // right after initialization of my_log_L. 

#define UPDATE_MY_LOG_L \
                 my_log_L += log_L;\
                 for(j=0; j<n_b_mode; j++)\
                 {\
...
#define UPDATE_FIRST_AND_SECOND \
  shift = 0;\
